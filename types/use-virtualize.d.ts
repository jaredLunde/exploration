 ...
 */
export declare function useVirtualize<Meta>(fileTree: FileTree<Meta>, config: UseVirtualizeConfig): UseVirtualizeResult<Meta>;
export declare function useHeight(windowRef: WindowRef, ResizeObserver: any): number;
export declare function useGlobalWindowHeight(windowRef: WindowRef): number | null;
export declare function useScrollPosition(windowRef: WindowRef, { offset }?: UseScrollPosition): {
    scrollTop: number;
    isScrolling: boolean;
};
...
export interface UseVirtualizeResult<Meta> {
     ...
     * @param config - Configuration options
     */
    scrollTo(scrollTop: number, config?: Pick<ScrollToNodeConfig, "behavior">): void;
    /**
     ...
     * ```
     */
    map(render: (config: VirtualizeRenderProps<Meta>) => React.ReactElement): React.ReactElement[];
}
