...
export declare class Tree<NodeData = {}> {
    ...
    constructor({ getNodes, root, comparator, }: {
    ...
    protected setNodes(branch: Branch<NodeData>, nodeIds: number[] | Node<NodeData>[]): void;
    private createVisibleNodes;
    dispose(): void;
}
export declare function isLeaf<T>(node: Node<T> | undefined): node is Leaf<T>;
export declare function isBranch<T>(node: Node<T> | undefined): node is Branch<T>;
